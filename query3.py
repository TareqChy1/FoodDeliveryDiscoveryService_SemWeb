# completed 5 number points for the projects. 
...
def query_restaurants(endpoint_url, date, time, max_delivery_price=None, max_distance=None, reference_lat=None, reference_lon=None):
    ...
    try:
        ...
        for result in results["results"]["bindings"]:
            ...
            if max_distance is not None and max_distance > 0 and reference_lat is not None and reference_lon is not None:
...
def main():
    ...
    results = query_restaurants(endpoint_url, date, time, max_delivery_price, max_distance, reference_lat, reference_lon)
